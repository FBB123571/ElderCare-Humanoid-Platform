...
> 第二十八届中国机器人及人工智能大赛 · 创新赛/机器人创新赛道  
> **团队「从容应队」**（中山大学）｜作品：基于大语言模型的智能养老陪伴机器人仿真平台
...
| Web 控制台 | **网络视频跌倒/心情分析** + **数字人剧场**（见 `docs/VIDEO_DIGITAL_HUMAN.md`） |
...
- [项目任务书（PDF）](docs/项目任务书.pdf) · [源稿](docs/项目任务书.md)
